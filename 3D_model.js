import { geometryData } from "./read_dae";
...
(async () => {
    ...
    {
        let cameraUniformBuffer, instanceStorageBuffer
        // {
        ...
        // }
        // {
        //     instanceStorageBuffer = device.createBuffer({
        //         size: 64,
        //         usage: GPUBufferUsage.UNIFORM | GPUBufferUsage.COPY_DST,
        //     })

        //     bindGroupLayoutInstance = device.createBindGroupLayout({
        //         entries: [{
        //             binding: 0,
        //             visibility: GPUShaderStage.VERTEX,
        //             buffer: {
